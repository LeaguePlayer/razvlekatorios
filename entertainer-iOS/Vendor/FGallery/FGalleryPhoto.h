...
@interface FGalleryPhoto : NSObject {
	...
	__unsafe_unretained NSObject <FGalleryPhotoDelegate> *_delegate;
...
-(id)initWithImage:(UIImage *)image fullsizeImage:(UIImage *)fullImage delegate:(NSObject<FGalleryPhotoDelegate>*)delegate;
